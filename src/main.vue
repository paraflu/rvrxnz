  ...
  data: function () {
    return {
      ...
      columns: [
        ...
        { field: 'col1', title: 'Col1', editor: 'boolean', width: '200px' },
        { field: 'col2', title: 'Col2', editor: 'boolean', width: '200px' },
        { field: 'col3', title: 'Col3', editor: 'boolean', width: '200px' },
        { field: 'col4', title: 'Col4', editor: 'boolean', width: '200px' },
        { field: 'col5', title: 'Col5', editor: 'boolean', width: '200px' },
        { field: 'col6', title: 'Col6', editor: 'boolean', width: '200px' },
        { field: 'col7', title: 'Col7', editor: 'boolean', width: '200px' },
        { field: 'col8', title: 'Col8', editor: 'boolean', width: '200px' },
        { field: 'col9', title: 'Col9', editor: 'boolean', width: '200px' },
        { field: 'col10', title: 'Col10', editor: 'boolean', width: '200px' },
        { field: 'col11', title: 'Col11', editor: 'boolean', width: '200px' },
        { field: 'col12', title: 'Col12', editor: 'boolean', width: '200px' },
        { field: 'col13', title: 'Col13', editor: 'boolean', width: '200px' },
        { field: 'col14', title: 'Col14', editor: 'boolean', width: '200px' },
        { field: 'col15', title: 'Col15', editor: 'boolean', width: '200px' },
        { field: 'col16', title: 'Col16', editor: 'boolean', width: '200px' },
        { field: 'col17', title: 'Col17', editor: 'boolean', width: '200px' },
        { field: 'col18', title: 'Col18', editor: 'boolean', width: '200px' },
        { field: 'col19', title: 'Col19', editor: 'boolean', width: '200px' },
        { field: 'col20', title: 'Col20', editor: 'boolean', width: '200px' },
      ],
      gridData: [],
    };
  },
